            ...
            <tbody>
                ...
                @foreach ($users as $key => $user)
                    <tr class="">
                        ...
                        <td>
                            <!-- Button trigger modal -->
                            <button type="button" class="btn btn-primary view-products" data-bs-toggle="modal"
                                data-bs-target="#product_model" data-user-id="{{ $user->id }}">
                                View
                            </button>
                        </td>
                ...
                fetch(`/user/product/${userId}`)
                    ...
                    .then(data => {
                        ...
                        data.products.forEach(product => {
                            ...
                            modalBody.innerHTML += productName +
                            '<br>'; // Append product name to modal body
                        });
                    })
                    .catch(error => {
