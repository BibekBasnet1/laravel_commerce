                        ...
                        <div class="col d-flex justify-content-center">
                            <div class="card card-1 m-3 p-2" style="width: 18rem; height: 350px;">
                                ...
                                @if (File::exists(public_path($product->image)))
                                    <img style="width:100%; height:50%;" src="{{ asset($product->image) }}"
                                        class="card-img-top" alt="">
                                @else
                                    <img style="width:100%; height:50%;" src="{{ asset('images/' . $product->image) }}"
                                        alt=""> 
                                @endif
                                ...
                                <div class="card-footer border-0 " style="height: 10%;background: none;">
                                    <a href="#" class="cart d-flex justify-content-end"
